...
## Next Session Start
1. Выполнить замеры производительности агрегаций на больших периодах (30/90/all) и 30+ учеников.
2. Доработать `v0.3.B` по результатам замеров (при необходимости оптимизировать запросы/мемоизацию).
