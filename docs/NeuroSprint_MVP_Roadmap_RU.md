...
## Next Session Start
1. Провести несколько практических прогонов встроенного бенчмарка и зафиксировать пороговые значения в документации.
2. При необходимости дооптимизировать `v0.3.B` (агрегации и UI-реактивность на периоде `all`).
3. Подготовить план `v0.4` (новые тренировочные модули на базе текущей архитектуры).
