...
- Decision Rush
- Memory Grid
- Мысленный поворот (Mental Rotation)
...
- `Block Pattern Recall` — переведён в основной каталог как «Мысленный поворот»; полная интеграция сохранения сессии ещё требует проверки
