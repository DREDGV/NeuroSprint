...
export const RELEASE_HISTORY: ReleaseEntry[] = [
  {
    version: "0.7.0-dev.3",
    date: "2026-04-04",
    title: "Публичный запуск, Competition, русские названия тренажёров",
    status: "dev",
    highlights: [
      ...
      "WebSocket клиент для real-time событий (подготовка к синхронным соревнованиям).",
      "Production аналитика: Vercel Analytics + Speed Insights с нормализацией маршрутов.",
      "Стабилизация feature flag store snapshots.",
      "Справка вынесена из основной навигации в отдельную кнопку «?» рядом с бейджем роли.",
      "Новые виджеты классов: тепловая карта активности, радар навыков, топ учеников, лидерборды.",
      "Исправлено: TrainingHub — убран дублирующий рендер, оптимизирована структура карточек навыков.",
      "Исправлено: RequirePermission — добавлен отсутствующий import."
    ]
  },
  {
    version: "0.7.0-dev.2",
