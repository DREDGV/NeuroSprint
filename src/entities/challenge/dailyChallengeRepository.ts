...
const MODE_TITLES: Record<TrainingModeId, string> = {
  ...
  memory_grid_classic_kids: "Memory Grid Kids",
  memory_grid_classic_kids_4x4: "Memory Grid Kids 4×4",
  memory_grid_classic_pro: "Memory Grid Pro",
  memory_grid_classic_pro_4x4: "Memory Grid Pro 4×4",
  memory_grid_rush: "Memory Grid Rush",
  memory_grid_rush_4x4: "Memory Grid Rush 4×4",
  memory_grid_rush_kids: "Memory Grid Rush Kids",
  memory_grid_rush_kids_4x4: "Memory Grid Rush Kids 4×4",
  memory_grid_rush_pro: "Memory Grid Rush Pro",
  memory_grid_rush_pro_4x4: "Memory Grid Rush Pro 4×4",
