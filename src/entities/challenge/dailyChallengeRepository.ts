...
const MODE_TITLES: Record<TrainingModeId, string> = {
  ...
  sprint_mixed: "Смешанный",
  reaction_signal: "Реакция: Сигнал",
  reaction_stroop: "Реакция: Цвет и слово",
  reaction_pair: "Реакция: Пара",
  reaction_number: "Реакция: Число-цель",
  nback_1: "N-Back 1",
  nback_1_4x4: "N-Back 1 4×4",
  nback_2: "N-Back 2",
  nback_2_4x4: "N-Back 2 4×4",
  nback_3: "N-Back 3",
  memory_grid_classic: "Сетка памяти Классика",
  memory_grid_classic_4x4: "Сетка памяти Классика 4×4",
  memory_grid_classic_kids: "Сетка памяти Дети",
  memory_grid_classic_kids_4x4: "Сетка памяти Дети 4×4",
  memory_grid_classic_pro: "Сетка памяти Про",
  memory_grid_classic_pro_4x4: "Сетка памяти Про 4×4",
  memory_grid_rush: "Сетка памяти Раш",
  memory_grid_rush_4x4: "Сетка памяти Раш 4×4",
  memory_grid_rush_kids: "Сетка памяти Раш Дети",
  memory_grid_rush_kids_4x4: "Сетка памяти Раш Дети 4×4",
  memory_grid_rush_pro: "Сетка памяти Раш Про",
  memory_grid_rush_pro_4x4: "Сетка памяти Раш Про 4×4",
  decision_kids: "Быстрые решения Дети",
  decision_standard: "Быстрые решения Стандарт",
  decision_pro: "Быстрые решения Про",
  spatial_memory_classic: "Пространственная память Классика",
  memory_match_classic: "Пары памяти Классика",
  pattern_classic: "Распознавание паттернов Классика",
  pattern_timed: "Распознавание паттернов На время",
