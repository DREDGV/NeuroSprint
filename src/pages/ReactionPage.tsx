  ...
  return (
    <section className="panel" data-testid="reaction-page">
      ...
      <p className="session-intro-text">
        Тренировка скорости реакции на визуальные сигналы. Учит быстро распознавать стимулы и мгновенно реагировать, что полезно в спорте, вождении и повседневной жизни.
      </p>

      <InfoHint title="Как играть в Реакцию" testId="reaction-how-to">
        <p><strong>1.</strong> Выберите вариацию тренировки (Сигнал, Строоп, Пара или Число-цель).</p>
        <p><strong>2.</strong> Нажмите «Начать раунд» и дождитесь сигнала.</p>
        <p><strong>3.</strong> После сигнала быстро нажмите верный вариант.</p>
        <hr />
        <p><strong>Что тренирует:</strong></p>
        <ul>
          <li>Скорость реакции на визуальные стимулы</li>
          <li>Концентрацию и готовность к действию</li>
          <li>Точность выбора при дефиците времени</li>
        </ul>
        <p><strong>Совет:</strong> Держите палец над экраном в готовности. Фокусируйтесь на центре, используя периферическое зрение для обнаружения сигнала.</p>
      </InfoHint>
