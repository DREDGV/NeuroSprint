...
-- Source of truth for the initial Supabase schema used by account auth/profile sync.
-- Self-service account deletion is intentionally NOT implemented via client-accessible SQL RPC in v1.
